...
public static partial class ecsm_portal_linkField
{
	...
	public const string PrimaryId = "ecsm_portal_linkid";
	...
	public const string CollectionSchemaName = "ecsm_portal_links";
	...
	public const string LogicalCollectionName = "ecsm_portal_links";
	...
	public const string EntitySetName = "ecsm_portal_links";
	...
	public const string LogicalName = "ecsm_portal_link";
	...
	public const string SchemaName = "ecsm_portal_link";
	...
	/// <summary>Type: Uniqueidentifier, RequiredLevel: SystemRequired, DisplayName: Portal Link, SchemaName: ecsm_portal_linkId, IntroducedVersion: 1.0.  Description: Unique identifier for entity instances</summary>
	public const string ecsm_portal_linkId = "ecsm_portal_linkid";

	/// <summary>Type: String, RequiredLevel: None, DisplayName: URL, Format: Url, MaxLength: 300, SchemaName: ecsm_url, IntroducedVersion: 1.0. </summary>
	...
	/// <summary>Type: State, RequiredLevel: SystemRequired, DisplayName: Status, SchemaName: statecode, IntroducedVersion: 1.0.  Description: Status of the Portal Link</summary>
	...
	/// <summary>Type: Status, RequiredLevel: None, DisplayName: Status Reason, SchemaName: statuscode, IntroducedVersion: 1.0.  Description: Reason for the status of the Portal Link</summary>
