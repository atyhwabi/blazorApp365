...
public sealed partial class ecsm_service_catalogue_item : Dictionary<string, object>
{
	...
	[JsonIgnore]
	public string? ecsm_CatalogueItemFormattedValue
	{
		get
		{
			return TryGetValue("_ecsm_catalogueitem_value@OData.Community.Display.V1.FormattedValue", out var value)
				? value is not null ? ((JsonElement)value).GetString()
				: null : null;
		}
	}
	...
	/// <summary>Type: Lookup, RequiredLevel: None, DisplayName: Catalogue Item, Format: None, SchemaName: ecsm_CatalogueItem, IntroducedVersion: 1.0.0.0. </summary>
	[JsonIgnore]
	public Guid? ecsm_CatalogueItem
	{
		get
		{
			return TryGetValue("_ecsm_catalogueitem_value", out var value)
				? value is not null ? ((JsonElement)value).GetGuid()
				: null : null;
		}
	}
	...
	/// <summary>Type: Lookup, RequiredLevel: None, DisplayName: Catalogue Item, Format: None, SchemaName: ecsm_CatalogueItem, IntroducedVersion: 1.0.0.0. </summary>
	[JsonIgnore]
	public Guid? ecsm_CatalogueItem_ecsm_catalogue_item
	{
		set
		{
			if (ContainsKey("ecsm_catalogueitem_ecsm_catalogue_item@odata.bind") is false || Remove("ecsm_catalogueitem_ecsm_catalogue_item@odata.bind"))
			{
				if (value is not null)
				{
					Add("ecsm_catalogueitem_ecsm_catalogue_item@odata.bind", $"({value})");
				}
				else
				{
					Add("_ecsm_catalogueitem_value", null);
				}
			}
		}
	}
	...
	[JsonIgnore]
	public string? ecsm_CatalogueItemName
	{
		get
		{
			return TryGetValue("ecsm_catalogueitemname", out var value)
				? value is not null ? ((JsonElement)value).GetString()
				: null : null;
		}
		set
		{
			if (ContainsKey("ecsm_catalogueitemname") is false || Remove("ecsm_catalogueitemname"))
			{
				Add("ecsm_catalogueitemname", value);
			}
		}
	}
	...
	[JsonIgnore]
	public string? ecsm_long_description
	{
		get
		{
			return TryGetValue("ecsm_long_description", out var value)
				? value is not null ? ((JsonElement)value).GetString()
				: null : null;
		}
		set
		{
			if (ContainsKey("ecsm_long_description") is false || Remove("ecsm_long_description"))
			{
				Add("ecsm_long_description", value);
			}
		}
	}
	...
	[JsonIgnore]
	public string? ecsm_service_catalogueFormattedValue
	{
		get
		{
			return TryGetValue("_ecsm_service_catalogue_value@OData.Community.Display.V1.FormattedValue", out var value)
				? value is not null ? ((JsonElement)value).GetString()
				: null : null;
		}
	}
	...
	/// <summary>Type: Lookup, RequiredLevel: None, DisplayName: Service Catalogue, Format: None, SchemaName: ecsm_service_catalogue, IntroducedVersion: 1.0.0.0. </summary>
	[JsonIgnore]
	public Guid? ecsm_service_catalogue
	{
		get
		{
			return TryGetValue("_ecsm_service_catalogue_value", out var value)
				? value is not null ? ((JsonElement)value).GetGuid()
				: null : null;
		}
	}
	...
	/// <summary>Type: Lookup, RequiredLevel: None, DisplayName: Service Catalogue, Format: None, SchemaName: ecsm_service_catalogue, IntroducedVersion: 1.0.0.0. </summary>
	[JsonIgnore]
	public Guid? ecsm_service_catalogue_ecsm_service_catalogue
	{
		set
		{
			if (ContainsKey("ecsm_service_catalogue_ecsm_service_catalogue@odata.bind") is false || Remove("ecsm_service_catalogue_ecsm_service_catalogue@odata.bind"))
			{
				if (value is not null)
				{
					Add("ecsm_service_catalogue_ecsm_service_catalogue@odata.bind", $"({value})");
				}
				else
				{
					Add("_ecsm_service_catalogue_value", null);
				}
			}
		}
	}
	...
	[JsonIgnore]
	public Guid? ecsm_service_catalogue_itemId
	{
		get
		{
			return TryGetValue("ecsm_service_catalogue_itemid", out var value)
				? value is not null ? ((JsonElement)value).GetGuid()
				: null : null;
		}
		set
		{
			if (ContainsKey("ecsm_service_catalogue_itemid") is false || Remove("ecsm_service_catalogue_itemid"))
			{
				Add("ecsm_service_catalogue_itemid", value);
			}
		}
	}
	...
	[JsonIgnore]
	public string? ecsm_service_catalogueName
	{
		get
		{
			return TryGetValue("ecsm_service_cataloguename", out var value)
				? value is not null ? ((JsonElement)value).GetString()
				: null : null;
		}
		set
		{
			if (ContainsKey("ecsm_service_cataloguename") is false || Remove("ecsm_service_cataloguename"))
			{
				Add("ecsm_service_cataloguename", value);
			}
		}
	}
	...
	[JsonIgnore]
	public string? ecsm_short_description
	{
		get
		{
			return TryGetValue("ecsm_short_description", out var value)
				? value is not null ? ((JsonElement)value).GetString()
				: null : null;
		}
		set
		{
			if (ContainsKey("ecsm_short_description") is false || Remove("ecsm_short_description"))
			{
				Add("ecsm_short_description", value);
			}
		}
	}
	...
	[JsonIgnore]
	public string? ecsm_TileLayoutFormattedValue
	{
		get
		{
			return TryGetValue("ecsm_tilelayout@OData.Community.Display.V1.FormattedValue", out var value)
				? value is not null ? ((JsonElement)value).GetString()
				: null : null;
		}
	}
	...
	/// <summary>Type: Picklist, RequiredLevel: None, DisplayName: Tile Layout, SchemaName: ecsm_TileLayout, IntroducedVersion: 1.0.0.0. </summary>
	[JsonIgnore]
	public int? ecsm_TileLayout
	{
		get
		{
			return TryGetValue("ecsm_tilelayout", out var value)
				? value is not null ? ((JsonElement)value).GetInt32()
				: null : null;
		}
		set
		{
			if (ContainsKey("ecsm_tilelayout") is false || Remove("ecsm_tilelayout"))
			{
				Add("ecsm_tilelayout", value);
			}
		}
	}
	...
	[JsonIgnore]
	public object? ecsm_tilelayoutName
	{
		get
		{
			return TryGetValue("ecsm_tilelayoutname", out var value)
				? value is not null ? ((JsonElement)value)
				: null : null;
		}
	}
