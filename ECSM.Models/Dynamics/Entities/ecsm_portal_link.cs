...
public sealed partial class ecsm_portal_link : Dictionary<string, object>
{
	...
	[JsonIgnore]
	public Guid? ecsm_portal_linkId
	{
		get
		{
			return TryGetValue("ecsm_portal_linkid", out var value)
				? value is not null ? ((JsonElement)value).GetGuid()
				: null : null;
		}
		set
		{
			if (ContainsKey("ecsm_portal_linkid") is false || Remove("ecsm_portal_linkid"))
			{
				Add("ecsm_portal_linkid", value);
			}
		}
	}
