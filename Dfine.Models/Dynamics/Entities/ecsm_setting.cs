...
public sealed partial class ecsm_setting : Dictionary<string, object>
{
	...
	/// <summary>Type: Virtual, RequiredLevel: None, DisplayName: LogoValue, MaxSizeInKb: 32768, MaxSizeInKb: 32768, SchemaName: ecsm_LogoValue, IntroducedVersion: 1.3.0.3.  Description: Test</summary>
	[JsonIgnore]
	public object? ecsm_LogoValue
	{
		get
		{
			return TryGetValue("ecsm_logovalue", out var value)
				? value is not null ? ((JsonElement)value)
				: null : null;
		}
	}

	/// <summary>Type: String, RequiredLevel: None, AttributeOf: ecsm_logovalue, Format: Text, MaxLength: 200, SchemaName: ecsm_LogoValue_Name, IntroducedVersion: 1.3.0.3. </summary>
	[JsonIgnore]
	public string? ecsm_LogoValue_Name
	{
		get
		{
			return TryGetValue("ecsm_logovalue_name", out var value)
				? value is not null ? ((JsonElement)value).GetString()
				: null : null;
		}
		set
		{
			if (ContainsKey("ecsm_logovalue_name") is false || Remove("ecsm_logovalue_name"))
			{
				Add("ecsm_logovalue_name", value);
			}
		}
	}
	...
	/// <summary>Type: Uniqueidentifier, RequiredLevel: SystemRequired, DisplayName: Setting, SchemaName: ecsm_settingId, IntroducedVersion: 1.0.  Description: Unique identifier for entity instances</summary>
	[JsonIgnore]
	public Guid? ecsm_settingId
	{
		get
		{
			return TryGetValue("ecsm_settingid", out var value)
				? value is not null ? ((JsonElement)value).GetGuid()
				: null : null;
		}
		set
		{
			if (ContainsKey("ecsm_settingid") is false || Remove("ecsm_settingid"))
			{
				Add("ecsm_settingid", value);
			}
		}
	}

	/// <summary>Type: String, RequiredLevel: None, DisplayName: Value, Format: Text, MaxLength: 100, SchemaName: ecsm_value, IntroducedVersion: 1.0. </summary>
	[JsonIgnore]
	public string? ecsm_value
	{
		get
		{
			return TryGetValue("ecsm_value", out var value)
				? value is not null ? ((JsonElement)value).GetString()
				: null : null;
		}
		set
		{
			if (ContainsKey("ecsm_value") is false || Remove("ecsm_value"))
			{
				Add("ecsm_value", value);
			}
		}
	}
	...
	/// <summary>Type: State, RequiredLevel: SystemRequired, DisplayName: Status, SchemaName: statecode, IntroducedVersion: 1.0.  Description: Status of the Setting</summary>
	[JsonIgnore]
	...
	/// <summary>Type: Status, RequiredLevel: None, DisplayName: Status Reason, SchemaName: statuscode, IntroducedVersion: 1.0.  Description: Reason for the status of the Setting</summary>
	[JsonIgnore]
