...
public sealed partial class ecsm_content_block : Dictionary<string, object>
{
	...
	[JsonIgnore]
	public Guid? ecsm_content_blockId
	{
		get
		{
			return TryGetValue("ecsm_content_blockid", out var value)
				? value is not null ? ((JsonElement)value).GetGuid()
				: null : null;
		}
		set
		{
			if (ContainsKey("ecsm_content_blockid") is false || Remove("ecsm_content_blockid"))
			{
				Add("ecsm_content_blockid", value);
			}
		}
	}
	...
	[JsonIgnore]
	public object? ecsm_content_file
	{
		get
		{
			return TryGetValue("ecsm_content_file", out var value)
	...
	[JsonIgnore]
	public string? ecsm_content_file_Name
	{
		get
		{
			return TryGetValue("ecsm_content_file_name", out var value)
				? value is not null ? ((JsonElement)value).GetString()
				: null : null;
		}
		set
		{
			if (ContainsKey("ecsm_content_file_name") is false || Remove("ecsm_content_file_name"))
			{
				Add("ecsm_content_file_name", value);
			}
		}
	}

	/// <summary>Type: String, RequiredLevel: None, DisplayName: Content Text, Format: Text, MaxLength: 2000, SchemaName: ecsm_ContentText, IntroducedVersion: 1.0. </summary>
	[JsonIgnore]
	public string? ecsm_ContentText
	{
		get
		{
			return TryGetValue("ecsm_contenttext", out var value)
				? value is not null ? ((JsonElement)value).GetString()
				: null : null;
		}
		set
		{
			if (ContainsKey("ecsm_contenttext") is false || Remove("ecsm_contenttext"))
			{
				Add("ecsm_contenttext", value);
			}
		}
	}
	...
	[JsonIgnore]
	public string? ecsm_ecsm_content_block_typeFormattedValue
	{
		get
		{
			return TryGetValue("ecsm_ecsm_content_block_type@OData.Community.Display.V1.FormattedValue", out var value)
				? value is not null ? ((JsonElement)value).GetString()
				: null : null;
		}
	}
	...
	/// <summary>Type: Picklist, RequiredLevel: ApplicationRequired, DisplayName: Content Block Type, SchemaName: ecsm_ecsm_content_block_type, IntroducedVersion: 1.0.0.0. </summary>
	[JsonIgnore]
	public int? ecsm_ecsm_content_block_type
	{
		get
		{
			return TryGetValue("ecsm_ecsm_content_block_type", out var value)
				? value is not null ? ((JsonElement)value).GetInt32()
				: null : null;
		}
		set
		{
			if (ContainsKey("ecsm_ecsm_content_block_type") is false || Remove("ecsm_ecsm_content_block_type"))
			{
				Add("ecsm_ecsm_content_block_type", value);
			}
		}
	}
	...
	[JsonIgnore]
	public object? ecsm_ecsm_content_block_typeName
	{
		get
		{
			return TryGetValue("ecsm_ecsm_content_block_typename", out var value)
				? value is not null ? ((JsonElement)value)
				: null : null;
		}
	}
