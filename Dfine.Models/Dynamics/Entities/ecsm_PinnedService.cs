...
public sealed partial class ecsm_PinnedService : Dictionary<string, object>
{
	...
	/// <summary>Type: Uniqueidentifier, RequiredLevel: SystemRequired, DisplayName: Pinned Service, SchemaName: ecsm_PinnedServiceId, IntroducedVersion: 1.0.  Description: Unique identifier for entity instances</summary>
	[JsonIgnore]
	public Guid? ecsm_PinnedServiceId
	{
		get
		{
			return TryGetValue("ecsm_pinnedserviceid", out var value)
				? value is not null ? ((JsonElement)value).GetGuid()
				: null : null;
		}
		set
		{
			if (ContainsKey("ecsm_pinnedserviceid") is false || Remove("ecsm_pinnedserviceid"))
			{
				Add("ecsm_pinnedserviceid", value);
			}
		}
	}

	/// <summary>Type: Lookup, RequiredLevel: None, DisplayName: Service, Format: None, SchemaName: ecsm_service, IntroducedVersion: 1.1.0.12. </summary>
	[JsonIgnore]
	public string? ecsm_serviceFormattedValue
	{
		get
		{
			return TryGetValue("_ecsm_service_value@OData.Community.Display.V1.FormattedValue", out var value)
				? value is not null ? ((JsonElement)value).GetString()
				: null : null;
		}
	}
	...
	/// <summary>Type: Lookup, RequiredLevel: None, DisplayName: Service, Format: None, SchemaName: ecsm_service, IntroducedVersion: 1.1.0.12. </summary>
	[JsonIgnore]
	public Guid? ecsm_service
	{
		get
		{
			return TryGetValue("_ecsm_service_value", out var value)
				? value is not null ? ((JsonElement)value).GetGuid()
				: null : null;
		}
	}
	...
	/// <summary>Type: Lookup, RequiredLevel: None, DisplayName: Service, Format: None, SchemaName: ecsm_service, IntroducedVersion: 1.1.0.12. </summary>
	[JsonIgnore]
	public Guid? ecsm_service_ecsm_service_catalogue_item
	{
		set
		{
			if (ContainsKey("ecsm_service_ecsm_service_catalogue_item@odata.bind") is false || Remove("ecsm_service_ecsm_service_catalogue_item@odata.bind"))
			{
				if (value is not null)
				{
					Add("ecsm_service_ecsm_service_catalogue_item@odata.bind", $"({value})");
				}
				else
				{
					Add("_ecsm_service_value", null);
				}
			}
		}
	}

	/// <summary>Type: String, RequiredLevel: None, AttributeOf: ecsm_service, Format: Text, MaxLength: 100, SchemaName: ecsm_serviceName, IntroducedVersion: 1.1.0.12. </summary>
	[JsonIgnore]
	public string? ecsm_serviceName
	{
		get
		{
			return TryGetValue("ecsm_servicename", out var value)
				? value is not null ? ((JsonElement)value).GetString()
				: null : null;
		}
		set
		{
			if (ContainsKey("ecsm_servicename") is false || Remove("ecsm_servicename"))
			{
				Add("ecsm_servicename", value);
			}
		}
	}
	...
	/// <summary>Type: State, RequiredLevel: SystemRequired, DisplayName: Status, SchemaName: statecode, IntroducedVersion: 1.0.  Description: Status of the Pinned Service</summary>
	[JsonIgnore]
	...
	/// <summary>Type: Status, RequiredLevel: None, DisplayName: Status Reason, SchemaName: statuscode, IntroducedVersion: 1.0.  Description: Reason for the status of the Pinned Service</summary>
	[JsonIgnore]
