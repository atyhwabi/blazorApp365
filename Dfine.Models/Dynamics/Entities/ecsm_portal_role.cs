...
public sealed partial class ecsm_portal_role : Dictionary<string, object>
{
	...
	/// <summary>Type: String, RequiredLevel: None, DisplayName: Description, Format: Text, MaxLength: 1000, SchemaName: ecsm_description, IntroducedVersion: 1.0. </summary>
	[JsonIgnore]
	...
	/// <summary>Type: Uniqueidentifier, RequiredLevel: SystemRequired, DisplayName: Portal Role, SchemaName: ecsm_portal_roleId, IntroducedVersion: 1.0.  Description: Unique identifier for entity instances</summary>
	[JsonIgnore]
	...
	/// <summary>Type: State, RequiredLevel: SystemRequired, DisplayName: Status, SchemaName: statecode, IntroducedVersion: 1.0.  Description: Status of the Portal Role</summary>
	[JsonIgnore]
	...
	/// <summary>Type: Status, RequiredLevel: None, DisplayName: Status Reason, SchemaName: statuscode, IntroducedVersion: 1.0.  Description: Reason for the status of the Portal Role</summary>
	[JsonIgnore]
