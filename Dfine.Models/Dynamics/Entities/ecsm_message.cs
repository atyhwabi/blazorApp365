...
public sealed partial class ecsm_message : Dictionary<string, object>
{
	...
	[JsonIgnore]
	public string? ecsm_message_
	{
		get
		{
			return TryGetValue("ecsm_message", out var value)
				? value is not null ? ((JsonElement)value).GetString()
				: null : null;
		}
		set
		{
			if (ContainsKey("ecsm_message") is false || Remove("ecsm_message"))
			{
				Add("ecsm_message", value);
			}
		}
	}
	...
	[JsonIgnore]
	public Guid? ecsm_messageId
	{
		get
		{
			return TryGetValue("ecsm_messageid", out var value)
				? value is not null ? ((JsonElement)value).GetGuid()
				: null : null;
		}
		set
		{
			if (ContainsKey("ecsm_messageid") is false || Remove("ecsm_messageid"))
			{
				Add("ecsm_messageid", value);
			}
		}
	}
