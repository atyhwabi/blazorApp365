...
public static partial class ecsm_content_blockField
{
	...
	public const string PrimaryId = "ecsm_content_blockid";
	...
	public const string CollectionSchemaName = "ecsm_content_blocks";
	...
	public const string LogicalCollectionName = "ecsm_content_blocks";
	...
	public const string EntitySetName = "ecsm_content_blocks";
	...
	public const string LogicalName = "ecsm_content_block";
	...
	public const string SchemaName = "ecsm_content_block";
	...
	/// <summary>Type: Uniqueidentifier, RequiredLevel: SystemRequired, DisplayName: Content Block, SchemaName: ecsm_content_blockId, IntroducedVersion: 1.0.  Description: Unique identifier for entity instances</summary>
	public const string ecsm_content_blockId = "ecsm_content_blockid";

	/// <summary>Type: Virtual, RequiredLevel: None, DisplayName: Content File, MaxSizeInKb: 32768, MaxSizeInKb: 32768, SchemaName: ecsm_content_file, IntroducedVersion: 1.0.0.0. </summary>
	public const string ecsm_content_file = "ecsm_content_file";

	/// <summary>Type: String, RequiredLevel: None, AttributeOf: ecsm_content_file, Format: Text, MaxLength: 200, SchemaName: ecsm_content_file_Name, IntroducedVersion: 1.0.0.0. </summary>
	public const string ecsm_content_file_Name = "ecsm_content_file_name";

	/// <summary>Type: String, RequiredLevel: None, DisplayName: Content Text, Format: Text, MaxLength: 100, SchemaName: ecsm_ContentText, IntroducedVersion: 1.0. </summary>
	public const string ecsm_ContentText = "ecsm_contenttext";

	/// <summary>Type: Picklist, RequiredLevel: ApplicationRequired, DisplayName: Content Block Type, SchemaName: ecsm_ecsm_content_block_type, IntroducedVersion: 1.0.0.0. </summary>
	public const string ecsm_ecsm_content_block_type = "ecsm_ecsm_content_block_type";

	/// <summary>Type: Virtual, RequiredLevel: None, AttributeOf: ecsm_ecsm_content_block_type, SchemaName: ecsm_ecsm_content_block_typeName, IntroducedVersion: 1.0.0.0. </summary>
	public const string ecsm_ecsm_content_block_typeName = "ecsm_ecsm_content_block_typename";
	...
	/// <summary>Type: State, RequiredLevel: SystemRequired, DisplayName: Status, SchemaName: statecode, IntroducedVersion: 1.0.  Description: Status of the Content Block</summary>
	...
	/// <summary>Type: Status, RequiredLevel: None, DisplayName: Status Reason, SchemaName: statuscode, IntroducedVersion: 1.0.  Description: Reason for the status of the Content Block</summary>
